...
namespace ProductRecommendationWebSite
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"F:\Document\Microsoft\文章\AI時代的網站與手機App建置與開發\AI時代的網站與手機App建置與開發Part14 - 使用ML.NET建立推薦系統\recommendation-ratings-train.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=31,LearningRate=0.00578145644967309,NumberOfIterations=87,Quiet=true}))      
